    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerText.setOnClickListener(v -> {
            try {
                ...
                // Don't add any flags that might interfere with normal activity flow
                startActivity(intent);
                // Don't finish this activity so user can come back
            } catch (Exception e) {
                Log.e("LoginActivity", "Error navigating to register: " + e.getMessage(), e);
                Toast.makeText(LoginActivity.this, "Error opening registration: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
